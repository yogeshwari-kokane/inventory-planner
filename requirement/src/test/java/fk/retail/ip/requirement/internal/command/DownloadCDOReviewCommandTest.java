...
public class DownloadCDOReviewCommandTest {
    ...
    public void downloadTestWithoutLastAppSupplier() throws IOException {
        ...
        //Assert.assertEquals(100, java.util.Optional.ofNullable(captor.getValue().get(0).getLastApp()));
        Assert.assertEquals("comment1",captor.getValue().get(0).getBizFinComment());
        ...
        //Assert.assertEquals("supplier2",captor.getValue().get(0).getLastSupplier());
        //Assert.assertEquals(120, java.util.Optional.ofNullable(captor.getValue().get(0).getLastApp()));
    }
