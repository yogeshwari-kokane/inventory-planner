 ...
 */
@Slf4j
public class PushToProcCommandV2 {
    ...
    @Inject
    PushToProcCommandV2(RequirementRepository requirementRepository, PushToProcClient pushToProcClient, FdpRequirementIngestorImpl fdpRequirementIngestor) {
